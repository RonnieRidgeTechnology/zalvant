            ...
            <div class="table-section">
                <div class="table-header">
                    ...
                    <div class="search-container">
                        ...
                        <a href="{{ route('contact.list') }}" class="btn btn-secondary reset-btn">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button
                                            ...
                                            data-service="{{ $contact->service->name ?? 'N/A' }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function fetchContacts(search = '') {
                const url = new URL('{{ route('contact.search') }}', window.location.origin);
                if (search) {
            ...
            // Delegate click event for all view buttons
