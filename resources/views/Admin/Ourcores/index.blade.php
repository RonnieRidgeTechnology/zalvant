...
@section('content')
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button class="action-btn delete"
                                                data-id="{{ route('Coure-value.destroy', $door->id) }}">
                                                <span class="btn-content">
    ...
    <div class="modal-overlay" id="addmodal" style="display:none;">
        <div class="modal">
            <div class="modal-header">
                <h3 id="modalTitle">Add Core Values</h3>
            ...
            <div class="modal-body">
                <form class="add-form" method="POST" id="cabinetDoorForm" enctype="multipart/form-data">
                    ...
                    <div class="language-tabs">
                        <button type="button" class="tab-button active" onclick="switchCoreTab(event, 'core-dutch')">
                            🇳🇱 Dutch (Default)
                        </button>
                        <button type="button" class="tab-button" onclick="switchCoreTab(event, 'core-english')">
                            🇬🇧 English
                        </button>
                        <button type="button" class="tab-button" onclick="switchCoreTab(event, 'core-french')">
                            🇫🇷 French
                        </button>
                        <button type="button" class="tab-button" onclick="switchCoreTab(event, 'core-german')">
                            🇩🇪 German
                        </button>
                    </div> -->

                    <!-- Dutch Tab -->
                    <div id="core-dutch" class="tab-content active">
                    ...
                    <!-- English Tab -->
                    <div id="core-english" class="tab-content">
                        <div class="form-group">
                    ...
                    <!-- French Tab -->
                    <div id="core-french" class="tab-content">
                        <div class="form-group">
                    ...
                    <!-- German Tab -->
                    <div id="core-german" class="tab-content">
                        <div class="form-group">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("openAddModal").addEventListener("click", function() {
            ...
            var storeUrl = '{{ route("Coure-value.store") }}';
            form.setAttribute("action", storeUrl);
            modalTitle.textContent = "Add Core Values Section";
            submitBtn.textContent = "Save";
            
            // Reset to Dutch tab
            document.getElementById('core-dutch').classList.add('active');
            document.getElementById('core-english').classList.remove('active');
            document.getElementById('core-french').classList.remove('active');
            document.getElementById('core-german').classList.remove('active');
        ...
        document.querySelectorAll(".action-btn.edit").forEach(function(button) {
            button.addEventListener("click", function() {
                ...
                form.setAttribute("action", `/admin/Coure-value/${id}`);
                modalTitle.textContent = "Edit Core Values Section";
        ...
        document.querySelectorAll(".action-btn.status").forEach(button => {
            button.addEventListener("click", function() {
                ...
                statusForm.setAttribute("action", `/admin/Coure-value/status/${id}/${newStatus}`);
    ...
    function switchCoreTab(event, tabId) {
