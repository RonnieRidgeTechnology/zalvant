...
class ServiceUpdate extends Model
{
    protected $fillable = [
        ...
        'deal_ai_desc_fr',
        'deal_ai_desc_de',
        'any_question_title_en',
        'any_question_title_fr',
        'any_question_title_de',
        'any_question_desc_en',
        'any_question_desc_fr',
        'any_question_desc_de',
        'meta_title_en',
        'meta_title_fr',
        'meta_title_de',
        'meta_desc_en',
    ...
    public function getLocalizedTechnologyTitle($locale = null)
    {
        return $this->getLocalizedField('technology_title', $locale);
    }
    public function getLocalizedTechnologyDesc($locale = null)
    {
        return $this->getLocalizedField('technology_desc', $locale);
    }
    ...
    public function getLocalizedAnyQuestionTitle($locale = null)
    {
        return $this->getLocalizedField('any_question_title', $locale);
    }
    public function getLocalizedAnyQuestionDesc($locale = null)
    {
        return $this->getLocalizedField('any_question_desc', $locale);
    }
    public function getLocalizedMetaTitle($locale = null)
    {
        return $this->getLocalizedField('meta_title', $locale);
    }
    public function getLocalizedMetaDesc($locale = null)
    {
        return $this->getLocalizedField('meta_desc', $locale);
    }
    public function getLocalizedMetaKeyword($locale = null)
    {
        return $this->getLocalizedField('meta_keyword', $locale);
    }
}
